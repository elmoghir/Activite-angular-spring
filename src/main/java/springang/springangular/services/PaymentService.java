package springang.springangular.services;
...
public class PaymentService {
    ...
    public Payment save(MultipartFile file, LocalDate date, double amount, PaymentType type, String studentCode) throws IOException {
